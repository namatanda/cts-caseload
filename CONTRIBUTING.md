...
[issues]: https://github.com/namatanda/cts-caseload/issues
...
- Fork the `cts-caseload` repo on GitHub.

- Clone your fork locally:

  ```bash
  git clone git@github.com:your_name_here/cts-caseload.git
  ```
  ...
  ```bash
  git clone --recursive-submodules git@github.com:your_name_here/cts-caseload.git
  ```
