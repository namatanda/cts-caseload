...
# set the kernel name
nb_kernel_rgx_aliases = {"cts-caseload.*": "python3", "conda.*": "python3"}
...
github_username = "namatanda"

html_context = {
    "github_user": "namatanda",
    "github_repo": "cts-caseload",
    "github_version": "main",
    "doc_path": "docs",
}
...
project = "cts-caseload"
copyright = "2024, Stan. M"
author = "Stan. M"
...
#     release = version
# except ImportError:
#     version = cts_caseload.__version__
#     # The full version, including alpha/beta/rc tags.
#     release = cts_caseload.__version__
...
html_theme_options = dict(
    ...
    # canonical_url="",
    repository_url=f"https://github.com/{github_username}/cts-caseload",
...
htmlhelp_basename = "cts_caseloaddoc"
...
def linkcode_resolve(domain, info):
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(cts_caseload.__file__))

    return f"https://github.com/{github_username}/cts-caseload/blob/{html_context['github_version']}/src/cts_caseload/{fn}{linespec}"
